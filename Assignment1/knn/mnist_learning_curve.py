...
plt.legend(loc="best")
plt.savefig(os.path.join(os.path.dirname(__file__), "./mnist_knn_learning_curve_for_training_size.png"), dpi=100)
plt.show()
...
plt.legend(loc="best")
plt.savefig(os.path.join(os.path.dirname(__file__), "./mnist_knn_runtime_for_training_size.png"), dpi=100)
plt.show()
...
plt.legend(loc="best")
plt.savefig(os.path.join(os.path.dirname(__file__), "./wine_boosting_learning_curve_for_training_size.png"), dpi=100)
plt.show()
...
plt.legend(loc="best")
plt.savefig(os.path.join(os.path.dirname(__file__), "./wine_boosting_runtime_for_training_size.png"), dpi=100)
plt.show()